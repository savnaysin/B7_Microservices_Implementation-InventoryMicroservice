...
public class InventoryController {
	...
	@PutMapping(path = "/inventory/updateInventory", consumes = "application/json", produces = "application/json")
	public Inventory updateInventoryInfo(@RequestBody Inventory inventory) throws NotFoundException {
		Integer productId = inventory.getProductId();
		Inventory foundInventory = inventoryRepository.findByProductIdOrderByUpdatedOn(productId);
